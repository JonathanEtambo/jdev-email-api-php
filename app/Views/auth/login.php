...
.auth-visual {
    ...
    min-height: 680px;
    background:
        linear-gradient(rgba(13,17,23,0.70), rgba(13,17,23,0.88)),
        ...
        <div class="col-lg-6 d-none d-lg-block">
            <div class="auth-visual auth-stagger" style="--delay: 0.1s">
                ...
                <h1 class="auth-visual-title">
                    Connecte tes sites vitrines à une API Email fiable.
                </h1>

                <p class="auth-visual-text">
                    JDevMail permet d’envoyer facilement les messages de contact,
                    demandes de devis, confirmations et notifications depuis tes sites vitrines,
                    sans complexité SMTP côté client.
                </p>
        ...
        <div class="col-md-10 col-lg-5">
            <div class="auth-panel p-4 p-lg-5">
                ...
                <p class="auth-subtitle small mb-4 auth-stagger" style="--delay: 0.4s">
                    Accède à ton dashboard JDevMail pour gérer tes sites et tes API Email.
                </p>

                <?php if (!empty($_GET['registered'])): ?>
                    <div class="alert alert-success border-0 shadow-sm auth-stagger" style="--delay: 0.1s">
                ...
                <form method="post" action="<?php echo APP_URL; ?>/login" novalidate>
                    ...
                    <div class="mb-4 auth-stagger" style="--delay: 0.6s">
                ...
                <div class="auth-divider text-center auth-stagger" style="--delay: 0.8s">
                    <span class="small text-muted">Nouveau sur JDevMail ?</span>
                    <a class="auth-link ms-1 small" href="<?php echo APP_URL; ?>/register">
